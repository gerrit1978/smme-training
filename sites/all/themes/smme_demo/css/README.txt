...
To use these stylesheets, rename the files and smme_demo with the name of your theme.
...
smme_demo-alpha-default-narrow.css  
...
smme_demo-alpha-default-normal.css
...
smme_demo-alpha-default-wide.css
